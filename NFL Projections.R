...
#projections_nfl$rec_nfl <- "--"
#projections_nfl$rec_nfl <- as.complex(projections_nfl$rec_nfl)  #not sure why I added this

#projections_nfl$rec_nfl[projections_nfl$rec_nfl == "--"] <- "0"  #converted receptions to 0s
