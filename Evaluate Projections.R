...
# -Find out what's causing Error in eval(expr, envir, enclos) : could not find #  #function "rcorrcens"
###########################
...
#Plot
ggplot(data=projectedWithActualPts, aes(x=projectedPts_fp, y=actualPts)) + geom_point() + geom_smooth() + xlab("Projected Fantasy Football Points") + ylab("Actual Fantasy Football Points") + ggtitle("Association Between Projected Points & Actual Points") +
