#Libraries load_or_install(c("XML","stringr","plyr"))
...
fumlMultiplier <- -2        #-2 pts per fumble lost
...
pa13Multiplier <- 4         #4 pts per 7-13 points allowed
pa17Multiplier <- 1         #1 pts per 14-17 points allowed
pa27Multiplier <- -1        #-1 pts per 22-27 points allowed
pa34Multiplier <- -4        #-4 pts per 28-34 points allowed
pa45Multiplier <- -7        #-7 pts per 35-45 points allowed
pa46Multiplier <- -10        #-10 pots per 46 points allowed
...
for(i in 1:length(years)){
  ...
  if(years[i] >= 2003 & years[i] <= 2011){
    ...
    simPApts[sim <= 0] <- pa0Multiplier
    simPApts[sim > 0 & sim <= 6] <- pa6Multiplier
    simPApts[sim >= 6 & sim <= 13] <- pa13Multiplier
    simPApts[sim >= 14 & sim <= 17] <- pa17Multiplier
    simPApts[sim >= 22 & sim <= 27] <- pa27Multiplier
    simPApts[sim >= 28 & sim <= 34] <- pa34Multiplier
    simPApts[sim >= 35 & sim <= 45] <- pa45Multiplier
    simPApts[sim >= 46] <- pa46Multiplier
